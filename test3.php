...
echo "<p>Shares on getPinterestCounter for <b>http://www.dailybest.it/2013/12/12/celebrita-vip-sosia-personaggi-storici/</b>:</p>";
echo $mb->getPinterestCounter("http://www.dailybest.it/2013/12/12/celebrita-vip-sosia-personaggi-storici/");
echo "<hr>";
