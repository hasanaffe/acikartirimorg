...
echo "Get info on <b>http://piccsy.com/2013/10/cute-dog</b><br>";
echo "<pre>".print_r($mb->getUrlInfo("http://piccsy.com/2013/10/cute-dog",2,10),true)."</pre>";
echo "<hr>";
...
echo "Get info on Youtube video <b>http://www.youtube.com/watch?v=KUVlrdfKowk</b><br>";
echo "<pre>".print_r($mb->getVideoUrlInfo("http://www.youtube.com/watch?v=KUVlrdfKowk"),true)."</pre>";
echo "<hr>";
...
echo "Get Facebook counters for <b>http://www.dailybest.it/2013/03/05/vita-programmatore-gif-animate/</b><br>";
echo "<pre>".print_r($mb->readFacebookCounters("http://www.dailybest.it/2013/03/05/vita-programmatore-gif-animate/"),true)."</pre>";
echo "<hr>";

// test readFacebookCounter
// -------------------------------------------------------------
echo "<h2>readTwitterCounter method</h2>";
echo "Get number of times the url <b>http://www.dailybest.it/2013/03/05/vita-programmatore-gif-animate/</b> has been twitted<br>";
echo "<pre>".print_r($mb->readTwitterCounter("http://www.dailybest.it/2013/03/05/vita-programmatore-gif-animate/"),true)."</pre>";
echo "<hr>";
...
echo "Get number of times the url <b>http://www.dailybest.it/2013/03/05/vita-programmatore-gif-animate/</b> has been twitted<br>";
echo "<pre>".print_r($mb->readGooglePlusCounter("http://www.dailybest.it/2013/03/05/vita-programmatore-gif-animate/"),true)."</pre>";
echo "<hr>";
