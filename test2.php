...
echo "<p>Get images for (for example) <b>funny face</b>, return 30 pics, showing a random one. See interative demo <a href=\"http://www.barattalo.it/demo/minibots.php\">here</a>.</p>";
$pics = $mb->getImage("funny face");
$x = $pics[rand(0,count($pics)-1)];
echo "<img src=\"".$x."\"/>";
echo "<hr>";

echo "<h2>getImageBig method using the previous result</h2>";
...
echo "<p>Get all the emails in this page <b>http://www.barattalo.it/about/</b>:</p>";
$mb = new Minibots();
$target = "http://www.barattalo.it/about/";
$page = $mb->getPage($target);
